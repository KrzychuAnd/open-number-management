...
include::{snippets}/add-resource/201/request-fields.adoc[]

Sample HTTP request:

include::{snippets}/add-resource/201/http-request.adoc[]
...
|400|Bad Request|Error in input, XSD failed validation, etc.
...
include::{snippets}/add-resource/201/http-response.adoc[]
...
include::{snippets}/add-resource/400/http-response.adoc[]

.Table Response Parameters

include::{snippets}/add-resource/400/response-fields.adoc[]
